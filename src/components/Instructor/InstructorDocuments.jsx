...
class InstructorDocuments extends React.Component {
    // set initial state
    state = {
        flightReviewDays: "",
        medicalClass: "",
    ...
    //         const documents = nextProps.documents;
    //         this.setState({
    //             documents: documents,
    //         })
    //     }
    ...
    calcFlightReviewDate = () => {
        ...
        let reviewExpireDate = new Date(this.props.instructorDocuments.flight_review_date); //convert currency end date to date
    ...
    calcMedicalClass = () => {
        ...
        let medicalDateDays =  (Math.round(new Date(this.props.instructorDocuments.medical_date))) / (1000 * 60 * 60 * 24);
        ...
        if(this.props.instructorDocuments.medical_class == 'one') {
        ...
        } else if(this.props.instructorDocuments.medical_class == 'two') {
        ...
        } else if(this.props.instructorDocuments.medical_class == 'three') {
        ...
        if(this.state.medicalClass) {
            return (
                <div className="row" style={{color: this.state.medicalClassFontColor}}>
                    ...
                    <div className="col-sm-4">
                        {
                            this.props.instructorDocuments.medical_date &&
                            `${dateFormat(this.props.instructorDocuments.medical_date, "longDate")}`
                        }
                    </div>
                </div>
            )
            ...
            <div>
                <div className="row" id="pilot-documents">
                    ...
                    <span className="col-sm-3" id="pilot-certificate-number">
                        {this.props.instructorDocuments.faa_certificate_number}
                    </span>
                ...
                <div className="row" style={{color: this.state.flightReviewFontColor}}>
                    ...
                    <div className="col-sm-4" >
                        {
                            this.props.instructorDocuments.flight_review_date &&
                            `${dateFormat(this.props.instructorDocuments.flight_review_date, "longDate")}`}
                    </div>
                </div>
